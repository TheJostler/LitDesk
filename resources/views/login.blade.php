<x-html>
    ...
    <x-body>
        <div class="box">
            <div class="pageTitle">
                <h1 class="mt-6 text-xl font-semibold text-gray-900">Lit Desk</h1>
            </div>
            ...
            <div class="mt-16">
                <x-card 
                    ...
                    link=""
                    body="">
                    <form class="p-6" action="{{ route('auth.login.submit') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <header>
                        <h2>Email:</h2>
                        </header>
                        ...
                        <div class="input-field col s12">
                            <input name="email" type="email" class="validate" placeholder="john@example.com">
                        </div>
                        </div>
                        ...
                        <div class="row">
                        <div class="input-field col s12">
                            <input type="submit" value="submit" class="btn btn-blue mt-4">
                        </div>
                        </div>
                    </form>
                </x-card>
